# Solar Panel Materials & Recycling Analysis

**A data-driven analysis of material composition, waste projections, and recycling potential of solar photovoltaic (PV) modules.**
...
```bash
git clone https://github.com/kellyjones99/solar-panel-recycling-analysis.git
cd solar-panel-recycling-analysis
```

Open the notebooks in Jupyter Lab or Jupyter Notebook to reproduce the results.

---

## Motivation

This project was developed as part of preparation for an application to the **MPhil in Advanced Materials for the Energy Transition** at the University of Cambridge. It reflects an interest in sustainable materials, circular economy approaches, and data-driven analysis of energy materials.
...
*Kelly Jones (2026). Solar Panel Materials & Recycling Analysis. GitHub repository.*
